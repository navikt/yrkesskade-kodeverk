...
class KodeverkControllerIT : AbstractIT() {
    ...
    fun `hent kodeverk kategorier for tidsrom`() {
        hentKategorierFor("tidsrom", 6)
    }

    @Test
    fun `hent kodeverk kategorier for alvorlighetsgrad`() {
        hentKategorierFor("alvorlighetsgrad", 6)
    }
    ...
    fun `hent kodeverk kategorier for Årsak og bakgrunn`() {
        hentKategorierFor("aarsakOgBakgrunn", 6)
    }

    @Test
    fun `hent kodeverk kategorier for Skadet kroppsdel`() {
        hentKategorierFor("skadetKroppsdel", 6)
    }

    @Test
    fun `hent kodeverk kategorier for skadetype`() {
        hentKategorierFor("skadetype", 6)
    }
    ...
    fun `hent kodeverk kategorier for Hva var bakgrunnen for hendelsen`() {
        hentKategorierFor("bakgrunnForHendelsen", 5)
    }
    ...
    fun `hent liste med kodeverkverdier for Tidsrom`() {
        ...
        hentKodeverdilisteFor("tidsrom", "tjenestepliktigOgfrivilligTjenestegjørende", 5)
    ...
    fun `hent liste med kodeverkverdier for Alvorlighetsgrad`() {
        ...
        hentKodeverdilisteFor("alvorlighetsgrad", "tjenestepliktigOgfrivilligTjenestegjørende", 5)
    ...
    fun `hent liste med kodeverkverdier for Årsak og bakgrunn`() {
        ...
        hentKodeverdilisteFor("aarsakOgBakgrunn", "tjenestepliktigOgfrivilligTjenestegjørende", 22)
    ...
    fun `hent liste med kodeverkverdier for Hvor på kroppen skjedde skaden`() {
        ...
        hentKodeverdilisteFor("skadetKroppsdel", "tjenestepliktigOgfrivilligTjenestegjørende", 40)
    ...
    fun `hent liste med kodeverkverdier for Hva slags skade er det`() {
        ...
        hentKodeverdilisteFor("skadetype", "tjenestepliktigOgfrivilligTjenestegjørende", 23)
    ...
    fun `hent liste med kodeverkverdier for Har skadelidt hatt fravær`() {
        ...
        hentKodeverdilisteFor("harSkadelidtHattFravaer", "tjenestepliktigOgfrivilligTjenestegjørende", 0)
    ...
    fun `hent liste med kodeverkverdier for Bakgrunnen for hendelsen`() {
        ...
        hentKodeverdilisteFor("bakgrunnForHendelsen", "tjenestepliktigOgfrivilligTjenestegjørende", 33)
